...
// ─── Linux syscall numbers (i386 — matching Linux x86 ABI) ──────────────
...
// ─── Linux stat structure (matches i386 struct stat) ─────────────────────
...
// ─── Linux process state for a running Linux binary ──────────────────────
