...
void KLS::Init() {
    ...
    addpkg("base-files",    "12.4",    true);
    addpkg("coreutils",     "9.4",     true);
    addpkg("bash",           "5.2.21", true);
    addpkg("libc6",          "2.38",   true);
    addpkg("libgcc-s1",      "13.2",   true);
    addpkg("libstdc++6",     "13.2",   true);
    addpkg("dash",           "0.5.12", false);
    addpkg("grep",           "3.11",   false);
    addpkg("sed",            "4.9",    false);
    addpkg("gawk",           "5.3",    false);
    addpkg("findutils",      "4.9.0",  false);
    addpkg("tar",            "1.35",   false);
    addpkg("gzip",           "1.13",   false);
    addpkg("bzip2",          "1.0.8",  false);
    addpkg("util-linux",     "2.39",   false);
    addpkg("procps",         "4.0.4",  false);
    addpkg("net-tools",      "2.10",   false);
    addpkg("iproute2",       "6.6",    false);
    addpkg("openssh-client", "9.6",    false);
    addpkg("vim-tiny",       "9.0",    false);
    addpkg("nano",           "7.2",    false);
    addpkg("wget",           "1.21.4", false);
    addpkg("curl",           "8.5.0",  false);
    addpkg("ca-certificates","2024",   false);
    addpkg("apt",            "2.7.10", false);
    addpkg("dpkg",           "1.22.2", false);
    addpkg("systemd",        "255",    false);
    addpkg("init-system-helpers","1.66",false);
    addpkg("gcc-13",         "13.2",   false);
    addpkg("make",           "4.3",    false);
    addpkg("python3.12",     "3.12.2", false);
    addpkg("git",            "2.43.0", false);
