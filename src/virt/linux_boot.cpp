...
bool LinuxBootLoader::LoadKernel(const uint8_t* image_data, uint32_t image_size,
    ...
    // ── Step 1: Copy real-mode setup code to LINUX_BOOT_PARAMS_ADDR ─────
    ...
    // ── Step 2: Load protected-mode kernel to 0x100000 ──────────────────
    ...
    // ── Step 4: Patch setup header in boot_params ───────────────────────
